...
def main():
    ...
    # batch_eq.main("audio\set0", 75, 230, 1.5) # bass and kick
    # batch_eq.main("audio\set1", 105, 1080, 1.5) # electric and bass
    # batch_eq.main("audio\set2", 600, 1180, 1.5) # electric and electric
